...
<div id="containerBack">
	<div id="containerInner">
		...
		<div id="bottomContentT"><img src="images/callout_fpo.jpg" alt="Hadley Exhibits Services"/>
		<div id="bottomContentNim">
		<img src="images/logo_nimlock1.jpg" alt="buy Nimlok"/><iframe src="http://www.nimloktradeshowdisplays.com/Includes/Templates/BuyButtons.aspx?tr=E17DD6F3995E&btn=White-115x20&url=h" scrolling="no" frameborder="0" height="20" width="115" allowtransparency="true" style="border:none; overflow:hidden; height:20px; width:115px;" ></iframe>
		</div><!--/bottomContentNim-->
		</div>
